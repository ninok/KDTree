...
#include "KDTreeDebugger.h"
#include "BBox.h"


void KDTreeDebugger::render(const KDTree& rTree, size_t nDebugLevel, bool bRenderPoints)
{
    renderNode(rTree.m_pRoot, rTree.m_aBBox, 0, nDebugLevel, bRenderPoints);
}

void KDTreeDebugger::renderNode(KDTree::Node* pNode, const BBox& rBBox, size_t nLevel, size_t nDebugLevel, bool bRenderPoints)
{
